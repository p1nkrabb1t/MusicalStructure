...
public class PlaylistAdapter extends ArrayAdapter<Playlist> {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        TextView playlistNameTextView = listItemView.findViewById(R.id.playlist_name);
        ...
        TextView genreTextView = listItemView.findViewById(R.id.genre);
        ...
        TextView tracksTextView = listItemView.findViewById(R.id.num_tracks);
        ...
        TextView lengthTextView = listItemView.findViewById(R.id.playlist_length);
